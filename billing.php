        ...
        <div class="card h-100">
          ...
          <div class="card-body p-3 pb-0">
            <ul class="list-group">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex flex-column">
                  <h6 class="text-dark mb-1 font-weight-bold text-sm">Battery</h6>
                  <span class="text-xs">Battery Avaiability</span>
                </div>
                <div class="d-flex align-items-center text-sm">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex flex-column">
                  <h6 class="text-dark mb-1 font-weight-bold text-sm">Door</h6>
                  <span class="text-xs">Door Status</span>
                </div>
                <div class="d-flex align-items-center text-sm">
                  <div id="isgate">Loading..</div>
                  <button class="btn btn-link text-dark text-sm mb-0 px-0 ms-4"><i class="fas fa-battery-full"></i> </button>
                </div>
              </li>
            </ul>
